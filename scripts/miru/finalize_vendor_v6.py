...
needle = '''    text = base.replace_exact(
        text,
...
'''
replacement = needle + '''    text = base.replace_exact(
        text,
...
if text.count(needle) != 1:
    raise SystemExit("of2fs teardown migration block missing or duplicated")
PATCHER.write_text(text.replace(needle, replacement, 1))
